...
//declarando o nome e os valores dos lanches
        ...
        CartItemElement.innerHTML = `
           <div class="flex items-center justify-between">
             <div class="font-medium">
                ...
                <p calss="fonte-medium mt-2">R$ ${item.price.toFixed(2)}</p>
             </div>
...
checkoutBtn.addEventListener('click', function(){
 ...
 // pedido somente no horario de funcionamento
...
// verificar a hora e manipular o card hoario
